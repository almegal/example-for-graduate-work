...
public class CreateOrUpdateAdDto {
    ...
    @ApiModelProperty(value = "Создание или обновление заголовка объявления", example = OpenApiConstant.TITLE)
    ...
    @ApiModelProperty(value = "Создание или обновление описания объявления", example = OpenApiConstant.DESCRIPTION)
